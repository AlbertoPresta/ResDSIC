...
def parse_args(argv):
    ...
    parser.add_argument("--checkpoint", type=str, default = "/scratch/ResDSIC/starting_models/indcomlrp/_very_best.pth.tar",help="Path to a checkpoint")
    ...
    parser.add_argument("--joiner_policy", type=str, default="", help="Batch size (default: %(default)s)")
    ...
    parser.add_argument("-m","--model",default="ind",choices=models.keys(),help="Model architecture (default: %(default)s)",)
    parser.add_argument("-md","--multiple_decoder", action="store_true", help="multiple_decoder")
    ...
    parser.add_argument("--save", action="store_true", default=True, help="Save model to disk") #dddd
