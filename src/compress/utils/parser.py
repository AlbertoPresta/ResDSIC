...
def parse_args(argv):
    ...
    parser.add_argument("--checkpoint", type=str, default = "/scratch/ResDSIC/models/res2/_very_best.pth.tar",help="Path to a checkpoint")#/scratch/ResDSIC/models/zero__multi__0.0035_0.05_cond_ind_two-levels_Trueconcatenation_False/_very_best.pth.tar
