...
def parse_args(argv):
    ...
    parser.add_argument("--lambda_list",dest="lmbda_list", nargs='+', type=float, default = [  0.05])
    parser.add_argument( "--batch_size", type=int, default=16, help="Batch size (default: %(default)s)")

    parser.add_argument("--scalable_levels", type=int, default=4, help="Batch size (default: %(default)s)")
    ...
    parser.add_argument("--patience", type=int, default=6, help="Batch size (default: %(default)s)")
    ...
    parser.add_argument("--joiner_policy", type=str, default = "block_concatenation",help="Path to a checkpoint") 
    parser.add_argument("--clip_max_norm",default=1.0,type=float,help="gradient clipping max norm (default: %(default)s",)
    parser.add_argument("--checkpoint", type=str, default = "none",help="Path to a checkpoint")
    parser.add_argument("--checkpoint_base", type=str, default = "/scratch/universal-dic/weights/q1/model.pth",help="Path to a checkpoint") #"/scratch/universal-dic/weights/q2/model.pth"
