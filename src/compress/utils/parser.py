...
def parse_args_video(argv):
    ...
    parser.add_argument("-m","--model",default="scalablessf",choices=video_models.keys(),help="Model architecture (default: %(default)s)",)
...
def parse_args(argv):
    ...
    parser.add_argument("--lambda_list",dest="lmbda_list", nargs='+', type=float, default = [ 0.0035, 0.060])
    ...
    parser.add_argument("--checkpoint_base", type=str, default =  "/scratch/base_devil/weights/q2/model.pth",help="Path to a checkpoint")
    parser.add_argument("--checkpoint_enh", type=str, default =  "/scratch/base_devil/weights/q5/model.pth",help="Path to a checkpoint") #"/scratch/universal-dic/weights/q2/model.pth"
