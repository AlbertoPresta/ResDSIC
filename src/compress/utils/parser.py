...
def parse_args(argv):
    ...
    parser.add_argument("-m","--model",default="conditional",choices=models.keys(),help="Model architecture (default: %(default)s)",)
    ...
    parser.add_argument("--lambda_list",dest="lmbda_list", nargs='+', type=float, default = [0.0035,0.0483])
