...
def parse_args(argv):
    ...
    parser.add_argument("-m","--model",default="cond_ind",choices=models.keys(),help="Model architecture (default: %(default)s)",)
    ...
    parser.add_argument("--lambda_list",dest="lmbda_list", nargs='+', type=float, default = [0.0035,0.009,0.025, 0.065])
    ...
    parser.add_argument("--joiner_policy", type=str, default = "concatenation",help="Path to a checkpoint") 
