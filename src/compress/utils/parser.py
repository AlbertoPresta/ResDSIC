...
def parse_args_video(argv):
    ...
    parser.add_argument("-d", "--uvg_dataset", type=str, default = "/data/uvg", help="Training dataset")
    parser.add_argument("-od", "--outputdir", type=str, default = "/data/video_output", help="Training dataset")
    ...
    parser.add_argument("--num_levels", type=int,default = 5, help="num_levels")
    parser.add_argument("--sigma0", type=int,default = 1.5, help="num_levels")
    parser.add_argument("--scale_field_shift", type=int,default = 1.0, help="num_levels")
    parser.add_argument("--mask_policy", type=str,default = "two-levels", help="mask_policy")
    parser.add_argument("--motion_input", type=str,default = "MMSR", help="motion input")
    parser.add_argument("--multiple_res_encoder", action="store_true", help="Use cuda")
    parser.add_argument("--multiple_res_decoder", action="store_true", help="Use cuda")
...
def parse_args_post(argv):
    parser = argparse.ArgumentParser(description="Example training script.") #dddd

    parser.add_argument("--model_base",type=str,default = "/_very_best.pth.tar")
    parser.add_argument("--checkpoint_base", type=str, default =  "frozen_005_05_memd_m4",help="Path to a checkpoint")
    parser.add_argument("-cl", "--cluster", type=str, default = "nautilus",choices=["hssh","nautilus"], help="Training dataset")
    ...
    parser.add_argument("--post_N", type=int, default=64, help="N")#ddddd#ddd
    parser.add_argument("--post_M", type=int, default=128, help="M")
    parser.add_argument("--patience", type=int, default=6, help="patience")#ddddddd

    parser.add_argument("--code", type=str, default = "post_001", help="Batch size (default: %(default)s)")
    parser.add_argument("--num_images_val", type=int, default=816, help="Batch size (default: %(default)s)")
    parser.add_argument("--mask_pol", type=str, default = "point-based-std", help="mask_policy")
    parser.add_argument("--valid_batch_size",type=int,default=16,help="Test batch size (default: %(default)s)",)
    parser.add_argument("--test_batch_size", type=int, default=1, help="Test batch size (default: %(default)s)", )
    parser.add_argument("--patch-size",type=int,nargs=2,default=(256, 256),help="Size of the patches to be cropped (default: %(default)s)",)
    parser.add_argument("--seed", type=float, help="Set random seed for reproducibility")
