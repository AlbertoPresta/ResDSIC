...
class scalable_imd(scalable_icd):
    def __init__(self, 
                 N=192,
                M=320,
    ...
    def print_information(self):
        ...
        for i in range(2):
            print(" g_s_" + str(i),": ",sum(p.numel() for p in self.g_s.parameters()))
    ...
    def forward(self, x, quality =None):
        ...
        for j,p in enumerate(list_quality): 
            ...
            mask = self.masking(latent_scales,scale_prog = scales_prog,pr = quality) #dddd
