from .conditional_single_decoder import conditional_scalable_icd
import torch 
import math 
...
class conditional_scalable_imd(conditional_scalable_icd):
    def __init__(self, 
                 N=192,
                M=320,
    ...
    def forward(self, x, quality =None):
        ...
        for j,p in enumerate(list_quality): 
            ...
            mask = self.masking(latent_scales,scale_prog = scales_prog,pr = quality)
            ...
            for slice_index, y_slice in enumerate(y_slices):
                ...
                if  quality != 0:
                    ...
                    scale_prog = scale_prog*block_mask + 1e-7
